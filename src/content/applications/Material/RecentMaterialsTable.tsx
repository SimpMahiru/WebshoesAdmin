...
import TableListMaterial from './TableListMaterial';
...
interface RecentMaterialsTableProps {
...
const labelTable = [
  { id: 1, label: 'ID' },
  { id: 2, label: 'Tên chất liệu' },
  { id: 3, label: 'Trạng thái' }
];

function RecentMaterialsTable({
  listMaterial,
  totalRecord,
  onClickPagination
}: RecentMaterialsTableProps) {
...
export default RecentMaterialsTable;